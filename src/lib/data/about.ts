...
export const about: AboutContent = {
  ...
  highlight:
    "Led React workshops for 60+ students as Web Development Lead at bITsera, MSIT's tech club — covering state management, API integration, and modular component design.",
};